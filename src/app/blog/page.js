    ...
    <div className=" bg-[#e4e4e4]  border-t-[1px]">
      <div className="bg-[#fff] px-4 py-2 flex gap-[10px] flex-wrap">
        <button
          className={
            tab === "billBoard"
              ? "px-4 py-2 rounded-full border-[1px] border-[#e4e4e4]  font-inter text-[16px] bg-[#FF80FD] text-[#fff]"
              : "px-4 py-2 rounded-full border-[1px] border-[#e4e4e4] text-[#98989c] font-inter text-[16px] hover:bg-[#FF80FD] hover:text-[#fff]"
          }
      ...
      <div className="flex lg:flex-row flex-col flex-wrap gap-[10px] w-[100%] p-4 m-auto w-[100%] max-w-[1280px]">
        {companyData.map((item, index) => (
          <div className="lg:w-[24%] w-[100%] m-auto cursor-pointer">
