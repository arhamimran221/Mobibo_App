        ...
        <div>
          {selectedRange.length === 0 ? (
            <p className="text-center m-auto font-inter tex-[24px]">
              To continue, Select Period of interset
            </p>
          ) : (
            ""
          )}
          <button
            className={
              selectedRange.length === 0
                ? "rounded-md bg-[#f7f7f7] px-3 py-2 text-sm font-semibold text-[#d5d5d7] shadow-sm cursor-not-allowed ml-auto mt-[10px]"
                : "rounded-md bg-[#80FFAB] px-3 py-2 text-sm font-semibold text-[#000] shadow-sm hover:text-indigo-500 ml-auto mt-[10px]"
            }
            onClick={nextClick}
          >
